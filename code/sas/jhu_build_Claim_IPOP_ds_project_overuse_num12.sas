...
/*this code modified 19mar2020 to remove outpatient and carrier--go to commit history 
	on master on that day if need the outpatient/carrier for future analyses*/

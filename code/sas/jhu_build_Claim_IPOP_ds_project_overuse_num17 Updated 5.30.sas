/********************************************************************
* Job Name: jhu_build_Claim_IPOP_ds_project_overuse_num17_summed.sas
...
/*inclusion criteria*/
		*people without diagnosis of neuropathy or weakness and with diagnosis of low back pain;
...
where 
		...
		and (	(a.elig_dt-60) <= b.&flag_popped_dt <=a.elig_dt	);  *Eliana: enter the time element here;
quit;
%mend;

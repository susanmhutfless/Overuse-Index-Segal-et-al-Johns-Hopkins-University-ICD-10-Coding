...
/*inclusion criteria*/
		*people with DIAGNOSES of mild TBI;

%let includ_hcpcs =
					'70551' '70552' '70553' 			;		*use for popped visit;



%let includ_pr10 =
					'B030Y0Z' 'B030YZZ' 'B030ZZZ'			; *use for popped visit;
%let includ_pr10_n = 7;		*this number should match number that needs to be substringed;

%let includ_dx10   = 'S060X0A';						*use for inclusion visit;
%let includ_dx10_n = 7;		
%let includ_drg = '0';

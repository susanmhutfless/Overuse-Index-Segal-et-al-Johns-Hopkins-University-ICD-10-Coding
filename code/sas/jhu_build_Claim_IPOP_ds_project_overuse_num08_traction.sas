/********************************************************************
* Job Name: jhu_build_Claim_IPOP_ds_project_overuse_num08_traction.sas
...
/*inclusion criteria*/
		*people with DIAGNOSES of low back pain;

%let includ_hcpcs =
					'97012'			;		*use for popped visit;



%let includ_pr10 =
					'2W65X0Z' '2W65XZZ'			; *use for popped visit;
...
%let 	flag_popped_dt_label			= 'indicator 8 date patient popped (IP=clm_admsn_dt OP=clm_from_dt)'	;
%let 	pop_age							= pop_8_age							;				
%let	pop_age_label					= 'age popped for pop 8'				;
...
%let	pop_icd_prcdr_cd1				= pop_8_icd_prcdr_cd1					;
